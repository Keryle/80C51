                           ...
                           0000CF   120 _TF2	=	0x00cf
                                      2 .area home (abs)
      000000 02 00 15         [24]    3 ljmp _main
                                      4 .area code (code)
                           000007     5 _Num = 7
                                      6 ;存入数据
      000000 75 30 22         [24]    7 mov 0x30,#0x22
      000003 75 31 52         [24]    8 mov 0x31,#0x52
      000006 75 32 12         [24]    9 mov 0x32,#0x12
      000009 75 33 A2         [24]   10 mov 0x33,#0xa2
      00000C 75 34 02         [24]   11 mov 0x34,#0x02
      00000F 75 35 12         [24]   12 mov 0x35,#0x12
      000012 75 36 E2         [24]   13 mov 0x36,#0xe2
                                     14 
      000015                         15 _main:
      000015 E5 30            [12]   16   mov a,0x30
      000017 12 00 1C         [24]   17   lcall _rank
      00001A 80 FE            [24]   18   01$:sjmp 01$
                                     19 
      00001C                         20 _rank:         ;首地址传递到a
      00001C 7F 07            [12]   21   mov r7,#_Num;每轮比较次数
      00001E 7E 07            [12]   22   mov r6,#_Num;循环次数
      000020 F8               [12]   23   mov r0,a  ; r0 首地址
      000021                         24 01$:
      000021 C2 00            [12]   25   clr 0
      000023                         26 03$:
      000023 E6               [12]   27   mov a,@r0
      000024 FA               [12]   28   mov r2,a
      000025 08               [12]   29   inc r0
      000026 E6               [12]   30   mov a,@r0 ;r2->first , a->second
      000027 C3               [12]   31   clr c
      000028 9A               [12]   32   subb a,r2
      000029 50 07            [24]   33   jnc 02$  ;a>=r2,jmp;else exchang
      00002B D2 00            [12]   34   setb 0x00
      00002D EA               [12]   35   mov a,r2
      00002E C6               [12]   36   xch a,@r0
      00002F 18               [12]   37   dec r0
      000030 F6               [12]   38   mov @r0,a
      000031 08               [12]   39   inc r0
      000032                         40 02$:
      000032 DF EF            [24]   41   djnz r7,03$;一轮比较
      000034 1E               [12]   42   dec r6
      000035 EE               [12]   43   mov a,r6
      000036 FF               [12]   44   mov r7,a
      000037 20 00 E7         [24]   45   jb 0x00,01$; 一轮比完没有交换，排序结束
      00003A 22               [24]   46   ret
